...
// Startup code for the executable 'svclayermcumgr'.
...
LE_SHARED const char* _svclayerMcuMgrComponent_svcLayerMcu_ServiceInstanceName = "svcLayerMcu";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t svclayermcumgr_exe_LogSession;
LE_SHARED le_log_Level_t* svclayermcumgr_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    svclayermcumgr_exe_LogSession = log_RegComponent("svclayermcumgr_exe", &svclayermcumgr_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_svclayerMcuMgrComponent.so");
